...
public class BlackBox implements Runnable
{
	...
	public static void main(String[] args) 
	{
		...
		// max packet size is 400 bytes
		// buffer capacity is 100*400 bytes
		BlackBox bb = new BlackBox(portNumber, 400, 1000*400, bConstant, RConstant, TConstant);
		new Thread(bb).start();
